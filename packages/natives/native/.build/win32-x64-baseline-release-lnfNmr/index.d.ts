 ...
 * visibility).
 */
export declare const enum ChunkAnchorStyle {
...
export declare const enum ChunkEditOp {
...
export declare const enum ChunkFocusMode {
...
export declare const enum ChunkReadStatus {
...
export declare const enum ChunkRegion {
  Head = '^',
  Body = '~'
}
